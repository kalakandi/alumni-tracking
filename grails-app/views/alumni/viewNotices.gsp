         ...
         <section id="schedule" class="section-with-bg">
                    <div class="container">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#otherCollegeNotice" role="tab" data-toggle="tab">Notice by Other Colleges</a>
                            </li>
                        </ul>
          ...
          <!-- Schdule College -->
                        ...
                        <!-- Schdule College -->
                            <div role="tabpanel" class="col-lg-9  tab-pane fade" id="otherCollegeNotice">

                                <g:each var="OthercollegeNotice" in="${(1..4)}">
                                    ...
                                    <div class="row schedule-item">
                                        ...
                                        <div class="col-md-9">
                                            <g:link data-toggle="modal" data-target="#myModal">
                                                ...
                                                <h4>Student-Alumni Mentorship <span>Engineering College Goa</span></h4>
                                                <p>Informative Alumni meet on the launch of myAlmaMatter. Our own Online Alumni Community.</p>
                                            </g:link>
                                        </div>
                                    </div>
