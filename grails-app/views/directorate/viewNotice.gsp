                ...
                <section id="schedule" class="section-with-bg">
                    <div class="container">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" href="#alumniNotice" role="tab" data-toggle="tab">Notices For Alumni</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#collegeNotice" role="tab" data-toggle="tab">Notice for Colleges</a>
                            </li>
                        </ul>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Directorate of Higher Education, Goa</h5>
